// Matter has out of date types,
// this file fixes those.
...
declare module "matter-js" {
    interface ICollision {
        ...
        axisNumber: number;
        /**
         * One of the bodies in the collision.
         */
        bodyA: Body;
        /**
         * One of the bodies in the collision.
        ...
        collided: boolean;
        /**
         * How far in one body got into the other.
         * The magnitude of penetration.
         */
        depth: number;
        /**
         * A unit vector pointing away from bodyA.
         * Clockwise from the tangent.
         */
        normal: Vector;
        /**
         * Unsure what this is.
        ...
        parentB: Body;
        /**
         * A vector describing how far inside of one body the other got.
         */
        penetration: Vector;
        /**
         * A vector tangent to the direction of the collision.
    ...
    export class Query {
        static collides(body: Body, bodies: Bodies): Collision[];
    }
}

// The one on NPM is wildly out of date,
// so sadly I had to copy paste.
// This came from https://github.com/kcolton/DefinitelyTyped/blob/8fcfb2a06d68a613347a78f4b6455f9dc21af562/types/matter-js/index.d.ts
